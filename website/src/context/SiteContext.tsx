...
const COLOR_PALETTES: Record<string, Record<string, string>> = {
  ...
  '#3ea75e': { // 品牌绿
    50: '239 248 242', 100: '217 240 224', 200: '182 226 194', 300: '138 205 155', 400: '92 181 113',
    500: '62 167 94', 600: '48 136 75', 700: '39 108 60', 800: '35 87 50', 900: '30 71 43', 950: '14 39 23',
  },
  '#8b5cf6': { // 紫色
