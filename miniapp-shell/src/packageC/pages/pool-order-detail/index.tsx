...
import { PoolOrderDetailPage as PoolOrderDetailPageComponent } from '@terminal-preview/components/pages/workbench'
...
function PoolOrderDetailPageContent() {
  ...
  useShareAppMessage(() => ({
    title: '订单详情',
    path: `/packageC/pages/pool-order-detail/index?id=${orderId}`,
  }))
  ...
  const handleNavigate = useCallback((page: string, params?: Record<string, string>) => {
    if (page === 'workbench') {
      ...
      console.warn('[PoolOrderDetailPage] 未知页面:', page)
    }
  }, [])
