...
import { DepartmentsSelectPage as DepartmentsSelectPageComponent } from '@terminal-preview/components/pages/workbench'
...
function DepartmentsSelectPageContent() {
  ...
  useShareAppMessage(() => ({
    title: '擅长科室',
    path: '/packageC/pages/departments-select/index',
  }))
  ...
  return (
    <View className="page-container">
      <DepartmentsSelectPageComponent
...
export default function DepartmentsSelectPage() {
  return (
    <QueryClientProvider client={queryClient}>
      <DepartmentsSelectPageContent />
    </QueryClientProvider>
  )
}
