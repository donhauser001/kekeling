...
export const orderStatusTypes = new Map<OrderStatus, string>([
  ...
  ['assigned', 'bg-blue-100/50 text-blue-700 dark:text-blue-300 border-blue-200'],
  ['confirmed', 'bg-indigo-100/50 text-indigo-700 dark:text-indigo-300 border-indigo-200'],
...
export const orderStatuses = [
  ...
  { label: '已分配', value: 'assigned', icon: CheckCircle },
