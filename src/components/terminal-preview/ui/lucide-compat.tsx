...
// 创建 Lucide 风格的图标组件
// 注意：iconName 参数使用 string 类型而非 IconName，避免 import type 的构建问题
function createLucideIcon(iconName: string): React.FC<LucideIconProps> {
...
// 创建一个占位图标（用于 iconfont 中未定义的图标）
function createPlaceholderIcon(fallbackName: string = 'grid'): React.FC<LucideIconProps> {
